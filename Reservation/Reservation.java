...
imgL=new JLabel(img);
imgL.setBounds(850,400,500,400);
...
{
System.out.println("Connection failed:01"+e1);
}
}
}
...
{
System.out.println("Connection failed:02"+e1);
}
}
if(e.getSource()==b2)
{
...
{
System.out.println("Connection failed:03"+e1);
}
try
{
...
{
System.out.println("Connection failed:04"+e1);
}
}
if(e.getSource()==b3)
{
