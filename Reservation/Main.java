...
Main()
{
img=new ImageIcon("bd.jpg");
imgL=new JLabel(img);
imgL.setBounds(0,0,1500,880);
f=new JFrame("Main ");
...
b1.setBackground(new Color(77,113,196));
b1.setForeground(new Color(255,255,255));
b2.setBackground(new Color(77,113,196));
b2.setForeground(new Color(255,255,255));
b3.setBackground(new Color(77,113,196));
b3.setForeground(new Color(255,255,255));
b4.setBackground(new Color(77,113,196));
